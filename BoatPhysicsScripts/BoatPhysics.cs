...
public class BoatPhysics : MonoBehaviour
{
    ...
    //A list with all vertices that are at the intersectionpoint between the air and water
    private List<Vector3> intersectionVertices = new List<Vector3>();

    //Script that displays the extra meshes
    private GenerateExtraBoatMeshes generateExtraBoatMeshes;
    ...
    void Start()
    {
        ...
        generateExtraBoatMeshes = new GenerateExtraBoatMeshes(boatMeshObj);
    ...
    void Update()
    {
        ...
        //generateExtraBoatMeshes.DisplayMesh(underWaterMesh, "UnderWater Mesh", modifyBoatMesh.underWaterTriangleData);

        //Display the above water mesh
        //generateExtraBoatMeshes.DisplayMesh(aboveWaterMesh, "AboveWater Mesh", modifyBoatMesh.aboveWaterTriangleData);

        //Display the mesh thats the mirror
        //generateExtraBoatMeshes.DisplayMesh(underWaterMirrorMesh, "UnderwaterMirror", modifyBoatMesh.aboveWaterTriangleData);

        //Generates from skirt
        generateExtraBoatMeshes.GenerateFoamSkirt(foamMesh, "Foam Skirt", intersectionVertices);
    }
    ...
    void AddUnderWaterForces()
    {
        ...
        //To calculate the slamming force the velocity at each of the original triangles
